...
$query = $con->prepare("SELECT * FROM tbl_employe");
$query->execute(); 
 ?>  
 <!DOCTYPE html>  
 <html>  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><input type="button" name="view" value="<?php echo $row["id"]; ?>" id="<?php echo $row["id"]; ?>" class="btn btn-info btn-xs view_data" /></td>  
                          </tr>  
                          <?php  
                          }  
                          ?>  
